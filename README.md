[![GitHub Actions](https://img.shields.io/github/actions/workflow/status/endobit/clog/test.yaml?branch=main)](https://github.com/endobit/clog/actions?query=workflow%3Abuild)
